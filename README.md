...
NOTE
----
This branch ('with-http-proxy-0.8.x') module works fine only with 'http-proxy' module 0.8.x or earlier.
The master branch is being developed to work with the latest version (1.0.x) of 'http-proxy' module.
